...
public class DDStepMechanic extends Mechanic {
    ...
    public DDStepMechanic(MechanicType<?> mechanicType, BlockEntity blockEntity, ActionFactory<Entity>.Instance entity_action, ActionFactory<Triple<World, BlockPos, Direction>>.Instance block_action, ConditionFactory<CachedBlockPosition>.Instance block_condition) {
