...
public class CCPacksMain implements ModInitializer, EntityComponentInitializer {
	...
	public static Block FALLBACK_HSLAB = new HSlabBlock(FabricBlockSettings.of(Material.WOOD));
	public static Block FALLBACK_VSLAB = new VSlabBlock(FabricBlockSettings.of(Material.WOOD));
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, identifier( "fallback_vslab"), FALLBACK_VSLAB);
		Registry.register(Registry.ITEM, identifier( "fallback_vslab"), new BlockItem(FALLBACK_VSLAB, new FabricItemSettings().group(ItemGroup.MISC)));
