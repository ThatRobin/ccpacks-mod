...
public class DDAxeItem extends AxeItem {
    ...
    public DDAxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings, Identifier source, List<PowerTypeReference> power, List<String> lore) {
