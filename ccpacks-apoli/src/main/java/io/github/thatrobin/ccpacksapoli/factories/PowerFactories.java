...
public class PowerFactories {
    ...
    public static void register() {
        ...
        register(new PowerFactory<>(CCPacksApoli.identifier("boss_bar"),
                ...
                data ->
                        (type, player) -> new BossBar(type, player, data.getInt("min"), data.getInt("max"), data.get("hud_render"), data.getInt("start_value"), data.get("min_action"), data.get("max_action")))
                .allowCondition());
