...
public class PowerFactories {
    ...
    public static void register() {
        ...
        register(new PowerFactory<>(CCPacksMain.identifier("action_on_projectile_land"),
                ...
                data ->
                        (type, player) -> {
                            ActionOnProjectileLand power = new ActionOnProjectileLand(type, player,(ConditionFactory<CachedBlockPosition>.Instance)data.get("block_condition"), (ActionFactory<Entity>.Instance)data.get("entity_action"), (ActionFactory<Triple<World, BlockPos, Direction>>.Instance)data.get("block_action"));
                            return power;
                        })
                .allowCondition());
