...
public class DDShovelItem extends ShovelItem implements PowerGrantingItem {
    ...
    public DDShovelItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings, List<String> lore, ColourHolder startColours, ColourHolder endColours, List<StackPowerExpansion> item_powers, LiteralText name) {
