...
public class DDHoeItem extends HoeItem implements PowerGrantingItem {
    ...
    public DDHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings, List<String> lore, ColourHolder startColours, ColourHolder endColours, List<StackPowerExpansion> item_powers, LiteralText name) {
