...
import io.github.ThatRobin.ccpacks.middleManTypes.*;
...
public class CCPackRegistry {
    ...
    public CCPackRegistry(Boolean isDir, File base, ZipFile file) throws IOException {
        this.base = base;
        this.file = file;
        if(isDir) {
            registerFromDir();
    ...
    public void registerElements(JsonObject jsonObject, SerializableData.Instance instance){
        ...
        if(instance.getString("type").equals("ccpacks:item")) {
            ...
            new MMItem((Identifier) instance2.get("identifier"), (List<String>)instance2.get("lore"), instance2.getInt("max_count"));
        } else if (instance.getString("type").equals("ccpacks:trinket")) {
            instance2 = SerializableObjects.itemData.read(jsonObject);
            new MMTrinket((Identifier) instance2.get("identifier"), (List<String>)instance2.get("lore"), instance2.getInt("durability"));
        } else if (instance.getString("type").equals("ccpacks:durable_item")) {
            instance2 = SerializableObjects.itemData.read(jsonObject);
            new MMDurableItem((Identifier) instance2.get("identifier"), (List<String>) instance2.get("lore"), instance2.getInt("durability"));
        } else if (instance.getString("type").equals("ccpacks:axe")) {
            instance2 = SerializableObjects.toolData.read(jsonObject);
            new MMAxeItem((Identifier) instance2.get("identifier"),instance2.getInt( "durability"),instance2.getFloat( "mining_speed_multiplier"),instance2.getInt("attack_speed"),instance2.getInt("mining_level"),instance2.getInt("enchantability"),instance2.getInt("attack_damage"), (List<String>)instance2.get("lore"));
            ...
            new MMBoots((Identifier) instance2.get("identifier"),instance2.getInt("durability"),instance2.getString("name"),instance2.getInt("protection"),instance2.getInt("toughness"),instance2.getInt("enchantability"),instance2.getInt("knockback_resistance"), (List<String>)instance2.get("lore"), (Item)instance2.get("repair_item"));
        } else if (instance.getString("type").equals("ccpacks:chestplate")) {
            instance2 = SerializableObjects.armorData.read(jsonObject);
            new MMChestplate((Identifier) instance2.get("identifier"),instance2.getInt("durability"),instance2.getString("name"),instance2.getInt("protection"),instance2.getInt("toughness"),instance2.getInt("enchantability"),instance2.getInt("knockback_resistance"), (List<String>)instance2.get("lore"), (Item)instance2.get("repair_item"));
            ...
            instance2 = SerializableObjects.armorData.read(jsonObject);
            new MMHelmet((Identifier) instance2.get("identifier"),instance2.getInt("durability"),instance2.getString("name"),instance2.getInt("protection"),instance2.getInt("toughness"),instance2.getInt("enchantability"),instance2.getInt("knockback_resistance"), (List<String>)instance2.get("lore"), (Item)instance2.get("repair_item"));
        } else if (instance.getString("type").equals("ccpacks:hoe")) {
            instance2 = SerializableObjects.toolData.read(jsonObject);
            new MMHoeItem((Identifier) instance2.get("identifier"),instance2.getInt( "durability"),instance2.getFloat( "mining_speed_multiplier"),instance2.getInt("attack_speed"),instance2.getInt("mining_level"),instance2.getInt("enchantability"),instance2.getInt("attack_damage"), (List<String>)instance2.get("lore"));
        } else if (instance.getString("type").equals("ccpacks:leggings")) {
            instance2 = SerializableObjects.armorData.read(jsonObject);
            new MMLegging((Identifier) instance2.get("identifier"),instance2.getInt("durability"),instance2.getString("name"),instance2.getInt("protection"),instance2.getInt("toughness"),instance2.getInt("enchantability"),instance2.getInt("knockback_resistance"), (List<String>)instance2.get("lore"), (Item)instance2.get("repair_item"));
        } else if (instance.getString("type").equals("ccpacks:pickaxe")) {
            instance2 = SerializableObjects.toolData.read(jsonObject);
            new MMPickaxeItem((Identifier) instance2.get("identifier"),instance2.getInt( "durability"),instance2.getFloat( "mining_speed_multiplier"),instance2.getInt("attack_speed"),instance2.getInt("mining_level"),instance2.getInt("enchantability"),instance2.getInt("attack_damage"), (List<String>)instance2.get("lore"));
        } else if (instance.getString("type").equals("ccpacks:shovels")) {
            instance2 = SerializableObjects.toolData.read(jsonObject);
            new MMShovelItem((Identifier) instance2.get("identifier"),instance2.getInt( "durability"),instance2.getFloat( "mining_speed_multiplier"),instance2.getInt("attack_speed"),instance2.getInt("mining_level"),instance2.getInt("enchantability"),instance2.getInt("attack_damage"), (List<String>)instance2.get("lore"));
        } else if (instance.getString("type").equals("ccpacks:sword")) {
            instance2 = SerializableObjects.toolData.read(jsonObject);
            new MMSword((Identifier) instance2.get("identifier"),instance2.getInt( "durability"),instance2.getFloat( "mining_speed_multiplier"),instance2.getInt("attack_speed"),instance2.getInt("mining_level"),instance2.getInt("enchantability"),instance2.getInt("attack_damage"), (List<String>)instance2.get("lore"));
        ...
        } else if (instance.getString("type").equals("ccpacks:universal_powers")) {
            instance2 = SerializableObjects.universalPowerData.read(jsonObject);
            new MMUniversalPowers((List<PowerTypeReference>)instance2.get("powers"));
