...
public class DDAxeItem extends AxeItem implements PowerGrantingItem {
    ...
    public DDAxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings, List<String> lore, ColourHolder startColours, ColourHolder endColours, List<StackPowerExpansion> item_powers) {
