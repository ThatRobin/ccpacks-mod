...
public class ContainerScreenHandler extends ScreenHandler {
    ...
    public boolean canUse(LivingEntity entity) {
        return this.inventory.canPlayerUse((PlayerEntity) entity);
    }

    public ItemStack transferSlot(LivingEntity entity, int index) {
    ...
    public void close(LivingEntity entity) {
        super.close((PlayerEntity) entity);
        this.inventory.onClose((PlayerEntity) entity);
    }
