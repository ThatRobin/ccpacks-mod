...
public class CustomLegging {
    public CustomLegging(String namespace, String id, Integer durability, String name, Integer protection, Integer toughness, Integer enchantability, Integer knockbackResistance) {
        ...
        Item EXAMPLE_ITEM = new ArmorItem(CUSTOM_MATERIAL, EquipmentSlot.LEGS, new Item.Settings().group(ItemGroup.COMBAT));
