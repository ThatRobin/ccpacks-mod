...
public class MMChestplate {
    ...
    public MMChestplate(Identifier identifier, Integer durability, String name, Integer protection, Integer toughness, Integer enchantability, Integer knockbackResistance, List<PowerTypeReference> power, List<String> lore, Item item) {
        ...
        Item EXAMPLE_ITEM = new DDArmorItem(CUSTOM_MATERIAL, EquipmentSlot.CHEST, new Item.Settings().group(ItemGroup.COMBAT), identifier, power, lore);
