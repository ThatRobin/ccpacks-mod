...
public class DDSlabBlock extends SlabBlock implements BlockEntityProvider, IDDBlock {
    ...
    public DDSlabBlock(Settings settings, List<MechanicTypeReference> mechanicTypeReferences, List<VoxelInfo> voxelInfoList) {
        super(settings);
