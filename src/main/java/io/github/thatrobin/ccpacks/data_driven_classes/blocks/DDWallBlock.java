...
public class DDWallBlock extends WallBlock implements BlockEntityProvider, IDDBlock {
    ...
    public DDWallBlock(Settings settings, List<MechanicTypeReference> mechanicTypeReferences, List<VoxelInfo> voxelInfoList) {
        super(settings);
