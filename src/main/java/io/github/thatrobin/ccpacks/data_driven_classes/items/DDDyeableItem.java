...
public class DDDyeableItem extends Item implements PowerGrantingItem, DyeableItem {
    ...
    public DDDyeableItem(Settings settings, LiteralText name, List<String> lore, List<StackPowerExpansion> item_powers) {
        this(settings, name, lore, null, null, item_powers);
    }

    public DDDyeableItem(Settings settings, LiteralText name, List<String> lore, ColourHolder startColours, ColourHolder endColours, List<StackPowerExpansion> item_powers) {
        super(settings);
        this.name = name;
        this.lore = lore;
    ...
    public int getColor(ItemStack stack) {
        ...
        return nbtCompound != null && nbtCompound.contains("color", 99) ? nbtCompound.getInt("color") : 11418944;
    }
}