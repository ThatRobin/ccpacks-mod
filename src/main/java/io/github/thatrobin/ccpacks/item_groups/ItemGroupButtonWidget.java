...
public class ItemGroupButtonWidget extends ButtonWidget {
    ...
    private final TabbedItemGroup.ButtonDefinition definition;
    private final boolean hoverReactive;

    public ItemGroupButtonWidget(int x, int y, boolean hoverReactive, TabbedItemGroup.ButtonDefinition definition, String groupTranslationKey, PressAction onPress) {
