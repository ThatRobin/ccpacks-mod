...
public class MMHelmet {
    ...
    public MMHelmet(Identifier identifier, Integer durability, String name, Integer protection, Integer toughness, Integer enchantability, Integer knockbackResistance, List<String> lore, Item item) {
        ...
        Item EXAMPLE_ITEM = new DDArmorItem(CUSTOM_MATERIAL, EquipmentSlot.HEAD, new Item.Settings().group(ItemGroup.COMBAT), lore);
