...
public interface Icon {
    ...
    static Icon of(ItemStack stack) {
        return new Icon.ItemIcon(stack);
    }
    ...
    static Icon of(Identifier texture, int u, int v, int textureWidth, int textureHeight) {
        return new Icon.TextureIcon(texture, u, v, textureWidth, textureHeight);
    }
    ...
    static Icon of(Identifier texture, int textureSize, int frameDelay, boolean loop) {
        return new Icon.AnimatedTextureIcon(texture, new SpriteSheetMetadata(textureSize, 16), frameDelay, loop);
    }
