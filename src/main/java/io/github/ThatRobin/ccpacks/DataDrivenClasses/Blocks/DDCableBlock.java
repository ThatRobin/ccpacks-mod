...
import io.github.ThatRobin.ccpacks.DataDrivenClasses.mechanics.DDFallMechanic;
import io.github.ThatRobin.ccpacks.DataDrivenClasses.mechanics.DDNeighourUpdateMechanic;
import io.github.ThatRobin.ccpacks.DataDrivenClasses.mechanics.DDStepMechanic;
import io.github.ThatRobin.ccpacks.DataDrivenClasses.mechanics.DDUseMechanic;
...
public class DDCableBlock extends BlockWithEntity {
    ...
    public DDCableBlock(Settings settings, List<VoxelInfo> voxelInfoList) {
        super(settings);
