...
public class CustomBoots {
    ...
    public CustomBoots(String namespace, String id, Integer durability, String name, Integer protection, Integer toughness, Integer enchantability, Integer knockbackResistance) {
        ...
        Item EXAMPLE_ITEM = new ArmorItem(CUSTOM_MATERIAL, EquipmentSlot.FEET, new Item.Settings().group(ItemGroup.COMBAT));
